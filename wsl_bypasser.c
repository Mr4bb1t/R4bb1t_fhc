...
/**
 * QoS Null Data com Duration máximo para NAV jamming.
 * esp_wifi_80211_tx exige header 802.11 completo (24+ bytes) — CTS puro
 * (10 bytes) causa crash por acesso a campos inexistentes.
 * Frame Control 0xC8,0x00: Type=Data, Subtype=QoS Null,
 *   To DS=0, From DS=0 → Addr1=DA(broadcast), Addr2=SA, Addr3=BSSID.
 * Muitos chipsets honram o Duration/NAV em QoS Null Data.
 */
